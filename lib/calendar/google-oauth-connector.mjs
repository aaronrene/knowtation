 ...
 *
 * Gated by CALENDAR_OAUTH_GOOGLE_AUTHORIZED (compile-time; KN-INF-3a flip 2026-07-07). Tests inject
...
/** Tier 3 compile-time gate — flipped 2026-07-07 (KN-INF-3a hosted calendar OAuth). */
export const CALENDAR_OAUTH_GOOGLE_AUTHORIZED = true;
...
export function isGoogleOAuthConnectorEnabled(opts = {}) {
  if (opts.authorizedOverride === false) {
    return false;
  }
