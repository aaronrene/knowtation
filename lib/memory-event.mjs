 ...
 * @param {{ vaultId?: string, ttl?: string|null, airId?: string }} [opts]
 * @returns {{ id: string, type: string, ts: string, vault_id: string, data: object, ttl: string|null, air_id?: string }}
