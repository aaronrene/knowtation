...
/**
 * Apply list-notes structural filters (folder, project, tag, dates, chain, entity, episode, content_scope).
 * Mutates no inputs; returns a new array.
 * @param {Array<{ path: string, frontmatter?: object, body?: string, project?: string, tags?: string[], date?: string, updated?: string, causal_chain_id?: string, entity?: string[], episode_id?: string }>} notes
 * @param {{
 *   folder?: string,
 *   project?: string,
 *   tag?: string,
