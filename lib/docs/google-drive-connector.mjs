/**
 * Inert Google Drive readonly OAuth connector.
 *
 * Production remains disabled by a source constant. Tests may inject
 * `authorizedOverride: true`; production routes must never pass that option.
 */
...
export const DOCS_OAUTH_GOOGLE_AUTHORIZED = false;
