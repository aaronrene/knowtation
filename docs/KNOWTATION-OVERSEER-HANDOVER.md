...
**Why this is next:** **FLOW-CAPTURE-LIVE-KN-b DONE** (BV `pass`, 13/13). Board
NEXT = **FLOW-CAPTURE-LIVEb** (Scooling Auto). tip_hash `sha256:8bc642bcd…`.

### THE ONE NEXT STEP — **Model: Auto** (Scooling product_order)

| | |
| --- | --- |
| **ID** | **FLOW-CAPTURE-LIVEb** |
| **Branch** | Scooling `feat/flow-capture-live` |
| **Repo** | **scooling** (product_order) |
| **Model** | **Auto** |

Paste the fence from `docs/OVERSEER-HANDOVER.md`.
