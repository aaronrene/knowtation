...
**Last updated:** 2026-03-27 — Hosted metadata bulk: **PR #65** Hub client + ops note (gateway **and** static Hub). §5 table: remove stale “Import 501” wording; import live with **`BRIDGE_URL`**.
