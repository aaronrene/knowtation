...
| **HUB-DASH-IA-merge** | **Operator + Auto** | **TODO** — authorized 2026-07-29; **deferred** to Muse-capable machine (no Muse/MuseHub in this env). Feature branch on `origin` @ `f75f07c`. | Tier 3 — Muse/`main` then muse-mirror → GitHub `main` (SD-14). Do not redesign shell. |
