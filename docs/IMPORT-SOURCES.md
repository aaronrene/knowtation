...
**Reference:** [IMPORT-URL-AND-DOCUMENTS-PHASES.md](./IMPORT-URL-AND-DOCUMENTS-PHASES.md) Phases **4A**, **4A₂**, **4B** (4A + bulk copy, 4A₂ + 4B **shipped** on `feat/import-url-documents-mcp`).
