...
| Documented operator smoke for **each** of the fourteen tools after deploy | **`backlinks`**, **`extract_tasks`**, and **`cluster`** smoke recorded (2026-04); see § *Production verification* subsections. Run the rest by following [§ How to test hosted MCP](#how-to-test-hosted-mcp). |
