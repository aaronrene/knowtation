...
7. ~~**MCP D2/D3, F2–F5**~~ — ✅ Complete + merged (PR #101) + **AWS gateway deployed** (EC2 `18.221.120.124`, PM2 + Nginx, OAuth 2.1 live). [BACKLOG-MCP-SUPERCHARGE.md](./BACKLOG-MCP-SUPERCHARGE.md). **Issue #2** deferred.
