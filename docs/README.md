...
| Doc | Purpose |
|-----|---------|
| [IMPLEMENTATION-PLAN.md](./IMPLEMENTATION-PLAN.md) | Phases 1–16+ roadmap (includes marketing + interop Phases 1–5 on `main`; Phase 6 on **`feature/phase6-product-depth`**) |
...
Session-only notes, forensic write-ups, old Cursor plan snapshots, and per-phase MCP memos stay **out of git**: use **`development/`** or a local **`docs/archive/`** folder (ignored — see repo `.gitignore`).
